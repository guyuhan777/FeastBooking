...
public class ActiveRingView extends View {
    ...
    public ActiveRingView(Context context) {
        super(context);
    }

    public ActiveRingView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ActiveRingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
